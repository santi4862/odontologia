            ...
            <div class="container">
                <div class="arow">
                    <div class="col-md-12 centered">
                        <h3 id="alumno" style="font-family: fantasy;color: green  "><span>Misión-Visión </span></h3>
                    </div>
                                        <div id="alumno" class="col-md-6">
                        <p style="font-size:18px; text-align:justify;color: green"><span><strong>Misión</span></strong></p>
    <p style="font-size:15px; text-align:justify;">Brindar servicios odontológicos integrales contribuyendo a resolver eficazmente los problemas de salud Oral de nuestros pacientes, aplicando para ello conceptos de excelencia en el servicio, eficiencia en la gestión y calidez personalizada en la atención.       <br>  <br>  <br>                   </p>
                    </div>
                    
                    <div id="alumno" class="col-md-6">
                        <p style="font-size:18px; text-align:justify;color: green"><span><strong>Visión</span></strong></p>                        
