                ...
                <div class="row">
                    <div class="col-md-12 centered">
                        <form  id="registro" name="registro" action="" method="POST">
                            ...
                            <div class="form-group">
                                <input type="password" required class="form-control" id="claves" name="claves" placeholder="Vuelva a Ingresar la Contraseña">
                            </div>
                        ...
                        <%                            if (request.getParameter("enviar") != null) {
                                ...
                                if (una.equals(dos)) {
                                    ...
                                    out.print("window.location = '../procesos/final.jsp?id=" + id + "';");
                                    out.print("}");
                                    out.print("});");
                                    out.print("</script>");
                                    ...
                                    out.print("if (isConfirm) {");
                                    out.print("window.location = '../procesos/cambiocon.jsp?id=" + id + "';");
                                    out.print("}");
                                    out.print("});");
                                    out.print("</script>");
                                }
