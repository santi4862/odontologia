                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            con.consulta("INSERT INTO noticias(titulo, encabezado, cuerpo, autor, fuente,fecha)VALUES ('" + titulo1 + "', '" + encabezado1 + "', '" + cuerpo1 + "', '" + autor1 + "', '" + fuente1 + "', '" + actual + "');");
                                            ...
                                            while (rs.next()) {
                                                ...
                                                out.print("window.location = '../notificacion/noticias_img.jsp?id=" + rs.getString("id_noticia") + "';");
                                                out.print("}");
                                                out.print("});");
                                                out.print("</script>");
                                            }
