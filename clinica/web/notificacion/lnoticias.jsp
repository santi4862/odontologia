                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form  id="noticias" name="noticias" action="noticias.jsp" method="POST">
                                    <center><h4><span class='help-block'> Consulta Noticias </span> </h4></center>
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("  <a href = '../notificacion/noticias_img.jsp?id=" + rs.getString("id_noticia") + "' <button class='btn btn-primary btn-xs'><i class='fa fa-paper-plane'></i></button> </a>");
