                                ...
                                <div class="form-group">
                                    ...
                                    <form id="mnoticia" name="mnoticia" action="" method="post">
                                        ...
                                        <div id="noti">
                                            <table width="100%">
                                                <tr>
                                                <h5><span class='help-block'> Titulo de la Noticia</span> </h5>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                <h5><span class='help-block'> Encabezado de Noticia</span> </h5>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                <h5><span class='help-block'>Cuerpo o Descripción de Noticia</span> </h5>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                <h5><span class='help-block'> Autor de la Noticia</span> </h5>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                <h5><span class='help-block'> Fuente de la Noticia</span> </h5>
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            String titulo1 = new String(request.getParameter("titulo").getBytes("ISO-8859-1"), "UTF-8");
                                            String encabezado1 = new String(request.getParameter("encabezado").getBytes("ISO-8859-1"), "UTF-8");
                                            String cuerpo1 = new String(request.getParameter("cuerpo").getBytes("ISO-8859-1"), "UTF-8");
                                            String autor1 = new String(request.getParameter("autor").getBytes("ISO-8859-1"), "UTF-8");
                                            String fuente1 = new String(request.getParameter("fuente").getBytes("ISO-8859-1"), "UTF-8");
                                            ...
                                            out.print("<script>");
                                            out.print("swal({title: 'Información del Sistema', text: 'Informacion Actualizada Correctamente', type: 'warning', showCancelButton: false, confirmButtonColor: '#01DF3A', confirmButtonText: 'Ok', cancelButtonText: 'No, cancel plx!', closeOnConfirm: false, closeOnCancel: false}, function(isConfirm) {");
                                            out.print("if (isConfirm) {");
                                            out.print("window.location = '../notificacion/noticias_img.jsp?id=" + id + "';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
