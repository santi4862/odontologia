                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + dia + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                ...
                if (rs.getString("martes").equals("t")) {
                    ...
                    if (sino == 1) {
                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diam + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                                    out.print("<td><a style='color:#FF3333'>No Disponible</a></td>");
                                }
                            } else {
                ...
                if (rs.getString("miercoles").equals("t")) {
                    ...
                    if (sino == 1) {
                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diami + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                                    out.print("<td><a style='color:#FF3333'>No Disponible</a></td>");
                                }
                            } else {
                ...
                if (rs.getString("jueves").equals("t")) {
                    ...
                    if (sino == 1) {
                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diaj + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                                    out.print("<td><a style='color:#FF3333'>No Disponible</a></td>");
                                }
                            } else {
                ...
                if (rs.getString("viernes").equals("t")) {
                    ...
                    if (sino == 1) {
                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diav + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                                    out.print("<td><a style='color:#FF3333'>No Disponible</a></td>");
                                }
                            } else {
                ...
                if (rs.getString("sabado").equals("t")) {
                    ...
                    if (sino == 1) {
                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + dias + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                                    out.print("<td><a style='color:#FF3333'>No Disponible</a></td>");
                                }
                            } else {
                ...
                if (rs.getString("domingo").equals("t")) {
                    ...
                    if (sino == 1) {
                        ...
                        if (fnueva.compareTo(factual) >= 0) {
                            if (fnueva.compareTo(factual) == 0) {
                                if ((hnueva.compareTo(hactual) >= 0)) {
                                    out.print("<td><a style='color:#34E768' href='ncitam.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diad + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Disponible</a></td>");
                                } else {
                                    out.print("<td><a style='color:#FF3333'>No Disponible</a></td>");
                                }
                            } else {
