                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form action="" id="ccita" name="ccita" method="post">
                                    ...
                                    <button type="button" class="btn btn-default btn-lg btn-block" onclick="location.href = 'listarcitasp.jsp'" id="buscar" name="buscar">Salir del Registro</button>
                                </form>
                                <%
                                    if (request.getParameter("confi") != null) {
                                        ...
                                        out.print("window.location = '../administracion/listarcitasa.jsp';");
                                        out.print("}");
                                        out.print("});");
                                        out.print("</script>");
                                    }
