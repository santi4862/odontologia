                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select *,(round(total::decimal,2))as tvalor from facturas where cliente='" + id + "' order by idfactura desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select *,(round(total::decimal,2))as tvalor from facturas where cliente='" + id + "' order by idfactura  desc";
                                            } else if (valor.equals("1")) {
                                                consulta = "select *,(round(total::decimal,2))as tvalor from facturas where cliente='" + id + "' order by idfactura  desc limit 25";
                                            } else if (valor.equals("2")) {
                                                consulta = "select *,(round(total::decimal,2))as tvalor from facturas  where cliente='" + id + "' order by idfactura  asc limit 25";
                                            } else if (valor.equals("3")) {
                                                consulta = "select *,(round(total::decimal,2))as tvalor from facturas where   cliente='" + id + "' and idfactura=" + buscar + " order by idfactura desc";
                                            } else {
