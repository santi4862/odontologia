                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form  id="nespecialista" name="nespecialista" action="nespecialista.jsp?id=<%out.print(id);%>" method="POST">
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Especialidad a Asignar </span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Correo Electronico </span> </h5>
                                    ...
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        while (rs.next()) {
                                            if (rs.getInt("count") == 0) {
                                                ...
                                                out.print("window.location = '../administracion/listaresp.jsp?id=" + id + "';");
                                                out.print("}");
                                                out.print("});");
                                                out.print("</script>");
                                            } else {
                                                out.print("sweetAlert('Información del Sistema', 'Especialidad ya registrada', 'warning'');");
                                            }
                                        }
