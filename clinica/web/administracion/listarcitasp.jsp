                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a title='Abrir Cita Medica'href = '../administracion/mcita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-success btn-xs'><i class='fa fa-building-o'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
