                            ...
                            <div class="form-panel">
                                <form  id="listaser" name="listarser" action="listarser.jsp" method="POST">
                                    <div class="form-group">
                                        <input name="codigoser" type="text" required class="form-control" id="codigoser" placeholder="Ingrese codigo unico de Especialidad" title="Ingrese codigo unico de Especialidad" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea rows="8" required class="form-control" id="detallerser" name="detalleser" placeholder="Ingrese un detalle del servicio" title="Ingrese un detalle del servicio"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" required class="form-control" id="precio" name="precio" placeholder="Ingrese el valor del servicio" title="Ingrese el valor del servicio">
                                    </div>
                                    <div class="form-group">
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        if (contador.equals("0")) {
                                            con.consulta("INSERT INTO servicios(nomservicio, idservicio,valservicio,especialidad,detalleser)VALUES ('" + nombre + "', '" + codigo + "', '" + precio + "', '" + espe + "', '" + detalle + "');");
                                            out.print("<script>");
                                            out.print("swal({title: 'Información del Sistema', text: 'Informacion Guardada Correctamente', type: 'warning', showCancelButton: false, confirmButtonColor: '#01DF3A', confirmButtonText: 'Ok', cancelButtonText: 'No, cancel plx!', closeOnConfirm: false, closeOnCancel: false}, function(isConfirm) {");
                                            out.print("if (isConfirm) {");
                                            out.print("window.location = 'listarser.jsp';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        } else {
                                ...
                                <div class="form-group">
                                    ...
                                    <% String consulta = "select * from servicios limit 100";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("   <a href = '../administracion/fotoser.jsp?id=" + rs.getString("idservicio") + "' <button class='btn btn-success btn-xs'><i class='fa fa-paper-plane'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
