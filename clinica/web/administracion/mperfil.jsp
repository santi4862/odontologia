                            ...
                            <div class="form-panel">
                                <form  id="mperfil" name="mperfil" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Código unico del Perfil</span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Nombre del Perfil</span> </h5>
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        if (contador == 0) {
                                            ...
                                            out.print("window.location = '../administracion/perfiles.jsp';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                            ...
                                            out.print("if (isConfirm) {");
                                            out.print("window.location = 'mperfil.jsp?id=" + id + "';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        }
