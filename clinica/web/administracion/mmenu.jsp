                            ...
                            <div class="form-panel">
                                ...
                                <form  id="mmenu" name="mmenu" action="" method="POST">
                                    <div class="form-group">
                                        <h5><span class='help-block'> Código Unico de Registro </span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Nombre del Menú </span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Enlace de la página del menú </span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Clase para dar icono al menú </span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> El menú depende de: </span> </h5>
                                    ...
                                    <div class="form-group">
                                        <h5><span class='help-block'> Visibilidad del menú </span> </h5>
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        if (contador == 0) {
                                            ...
                                            out.print("window.location = '../administracion/listarmen.jsp';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        } else {
                                            out.print("<script>");
                                            out.print("swal({title: 'Información del Sistema', text: 'Codigo Duplicada', type: 'warning', showCancelButton: false, confirmButtonColor: '#01DF3A', confirmButtonText: 'Ok', cancelButtonText: 'No, cancel plx!', closeOnConfirm: false, closeOnCancel: false}, function(isConfirm) {");
                                            out.print("if (isConfirm) {");
                                            out.print("window.location = 'mmenu.jsp?id=" + id + "';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        }
