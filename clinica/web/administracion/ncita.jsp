                            ...
                            <div class="form-panel">
                                <form  id="listarei" name="listarei" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<%out.print(fecha);%>" required class="form-control" id="fecha" name="fecha" readonly=”readonly” placeholder="Fecha">
                                    </div>
                                    <div class="form-group">
                                        <h5><span class='help-block'> Hora Elegida de la Reserva </span></h5>
                                        <input type="text" value="<%out.print(hora);%>" required class="form-control" id="hora" name="hora" readonly=”readonly” placeholder="Hora">
                                    </div>
                                    <div class="form-group">
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        if (contador.equals("0")) {
                                            ...
                                            out.print("window.location = '../reportes/proformas.jsp?hora=" + hora + "&&fecha=" + fecha + "&&idd=" + dni + "';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        } else {
