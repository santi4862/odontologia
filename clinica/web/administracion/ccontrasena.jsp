                            ...
                            <div class="form-panel">
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        if (n.equals(rn)) {
                                            ...
                                            out.print("window.location = '../administracion/listar.jsp';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        } else {
                                            ...
                                            out.print("if (isConfirm) {");
                                            out.print("window.location = '../administracion/ccontrasena.jsp?id=" + id + "';");
                                            out.print("}");
                                            out.print("});");
                                            out.print("</script>");
                                        }
                                ...
                                <%
                                    if (request.getParameter("cambio") != null) {
                                        ...
                                        ms.asunto("Cambio de Contraseña usuario " + id + " en " + empresa);
                                        ms.mensaje("Bienvenido a " + empresa + " \n \n "
                                                + "Ha solicitado un camibio de contraseña a " + empresa + " \n \n "
                                                + "Para cambiar su contraseña y volver a utilzar este Servicio. Haz click en este enlace \n \n "
                                                + "para poder cambiar su contraseña y acceder al sistema: \n \n"
                                                + dominio + "/clinica/procesos/cambiocon.jsp?id=" + id + "  \n \n "
                                        ...
                                        ms.SendMail();
                                        out.print("<script>");
                                        out.print("swal({title: 'Información del Sistema', text: 'Enlace enviado Exitosamente', type: 'warning', showCancelButton: false, confirmButtonColor: '#01DF3A', confirmButtonText: 'Ok', cancelButtonText: 'No, cancel plx!', closeOnConfirm: false, closeOnCancel: false}, function(isConfirm) {");
                                        out.print("if (isConfirm) {");
                                        out.print("window.location = '../administracion/listar.jsp';");
                                        out.print("}");
                                        out.print("});");
