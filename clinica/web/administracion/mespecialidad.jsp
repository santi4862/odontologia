                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <h5><span class='help-block'> Código Unico del Registro</span> </h5>");
                                            ...
                                            out.print(" </div>");
                                            out.print(" <div class='form-group'>");
                                            out.print("    <h5><span class='help-block'> Nombre de la Especialidad </span> </h5>");
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            if (com.equals("0")) {
                                                ...
                                                out.print("window.location = '../administracion/listare.jsp';");
                                                out.print("}");
                                                out.print("});");
                                                out.print("</script>");
                                            } else {
                                                out.print("<script>");
                                                out.print("swal({title: 'Información del Sistema', text: 'Nombre Duplicada', type: 'warning', showCancelButton: false, confirmButtonColor: '#01DF3A', confirmButtonText: 'Ok', cancelButtonText: 'No, cancel plx!', closeOnConfirm: false, closeOnCancel: false}, function(isConfirm) {");
                                                out.print("if (isConfirm) {");
                                                out.print("window.location = 'mespecialidad.jsp?id=" + id + "';");
                                                out.print("}");
                                                out.print("});");
                                                out.print("</script>");
                                            }
