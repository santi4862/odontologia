        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper">
                    <center><h4><i class="fa fa-refresh"></i>Imagen Actual del Servicio</h4></center>
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <br><br>
                                <form class="form-horizontal style-form" action="../procesos/subirser.jsp?id=<%out.print(id);%>" enctype="multipart/form-data" method="post">
