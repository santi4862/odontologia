                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form  id="listarcitas" name="listarcitas" action="listarcitas.jsp" method="POST">
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tbuscar" id="tbuscar">
                                            ...
                                            <option value="0">Citas Pendientes</option>
                                            <option value="1">Citas Aplicadas</option>
                                            <option value="2">Citas Canceladas</option>
                                            <option value="3">Citas No Asistidas</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Pendiente' order by idcita desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (buscar.equals("")) {
                                                if (valor.equals("0")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Pendiente'";
                                                } else if (valor.equals("1")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Aplicada'";
                                                } else if (valor.equals("2")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Cancelado'";
                                                } else if (valor.equals("3")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='No asistio'";
                                                } else if (valor.equals("4")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "'";
                                                }
                                            } else {
                                                if (valor.equals("0")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Pendiente' and fecha='" + buscar + "'";
                                                } else if (valor.equals("1")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Aplicada' and fecha='" + buscar + "'";

                                                } else if (valor.equals("2")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "' and estcita='Cancelado' and fecha='" + buscar + "'";

                                                } else if (valor.equals("3")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "'  and estcita='No asistio' and fecha='" + buscar + "'";

                                                } else if (valor.equals("4")) {
                                                    consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and paciente='" + id + "'  and fecha='" + buscar + "'";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a title='Conformar Reservación' href = '../procesos/acita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-success btn-xs'><i class='fa fa-play'></i></button></a>");
                                            out.print("   <a title='Cancelar Reservación' href = '../procesos/bcita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-stop'></i></button></a>");
                                            out.print("   <a title='Borrar Cita por Completo' href = '../procesos/ecita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-danger btn-xs'><i class='fa fa-eraser'></i></button></a>");
                                            out.print("   <a title='Suber Imagen de Pago' href = 'fotot.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-upload'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
