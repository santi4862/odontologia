                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        Date hoy = new Date();
                                        String consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estpago='Pendiente'  order by idcita desc limit 50";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estpago='Pendiente'  and fecha='" + hoy + "' order by idcita desc limit 50";
                                                ...
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estpago='Pendiente' and fecha='" + buscar + "' order by idcita desc limit 50";
                                            } else if (valor.equals("3")) {
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estpago='Pendiente' order by idcita desc limit 50";
                                            }
                                        }
