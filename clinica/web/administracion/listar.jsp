                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a title='Editar Registro' href = '../administracion/mregistro.jsp?id=" + rs.getString("dni") + "' <button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a>");
