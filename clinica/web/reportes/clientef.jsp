                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form  id="clientes" name="clientes" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="text" required  class="form-control" id="cantidad" value="0" name="cantidad" placeholder="Indicadores para generar el reporte" title="Finalizar reporte hasta">
                                    </div>
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tipor" id="tipor">
                                            <option value="">Seleccione tipo de reporte a generar</option>
                                            <option value="0">Consultorios que han tenido mas citas Medicas</option>
                                            <option value="1">Horas mas frecuentes para una Reservación</option>
                                            <option value="2">Fechas con mas Reservaciones Medicas</option>
                                        </select>
                                    </div>
