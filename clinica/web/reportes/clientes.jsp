                            ...
                            <div class="form-panel">
                                ...
                                <form  id="clientes" name="clientes" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tipor" id="tipor">
                                            ...
                                            <option value="0">Clientes que han reservado citas  con mas frecuencia </option>
                                            <option value="1">Medicos que han obtenido mas atenciones medicas</option>
                                            <option value="2">Consultorios con mas reservaciones medicas</option>
                                            <option value="3">Saldos obtenidos por venta de servicios</option>
                                            <option value="4">Situación de estado de pagos</option>
                                            <option value="5">Rentabilidad de Venta de Servicios por Especialidades</option>
                                        </select>
                                    </div>
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        } else if (tipor.equals("4")) {
                                            out.println("<script language='javascript'>window.location='../reportes/vcliente.jsp?from=" + from + "&&to=" + to + "&&tipor=pdf/vdeudas.jasper'</script>;");
                                        } else if (tipor.equals("5")) {
                                            out.println("<script language='javascript'>window.location='../reportes/vcliente.jsp?from=" + from + "&&to=" + to + "&&tipor=pdf/dclientes.jasper'</script>;");
                                        }
                                    }
                                %>
                            </div>
